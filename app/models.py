...
class SuggestionsCritics(models.Model):
    ...
    phone_number = models.CharField(max_length=11, blank=True, validators=[MinLengthValidator(
        11, "کمتر از 11 رقم وارد نکنید."), MaxLengthValidator(11, "بیشتر از 11 رقم وارد نکنید")])
...
class Order(models.Model):
    name = models.CharField(max_length=255)
    email = models.EmailField(blank=True)
    phone_number = models.CharField(max_length=11, validators=[MinLengthValidator(
        11, "کمتر از  11 رقم وارد نکنید ."), MaxLengthValidator(11, "بیشتر از 11 رقم وارد نکنید")])
    amount = models.PositiveIntegerField(validators=[MinValueValidator(
        1, "سفارش باید بیش از یک عدد باشه"), MaxValueValidator(10, "سفارش باید کمتر  از 11 عدد باشه ")])
